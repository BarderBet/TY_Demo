...
class DraggableBottomSheet extends StatefulWidget {
  ...
  final GestureTapCallback? barrierTap;
...
class DraggableBottomSheetState extends State<DraggableBottomSheet> {
  ...
  Widget build(BuildContext context) {
    Widget buildWidget =
        widget.useSafeArea ? SafeArea(child: _body()) : _body();
    entry = OverlayEntry(
  ...
  Widget _barrier() {
    print("barrierDismissible:${widget.barrierDismissible}");
    return IgnorePointer(
      ignoring: !widget.barrierDismissible,
      child: GestureDetector(
        onTap: widget.barrierDismissible
            ? widget.barrierTap ?? _barrierOnTap
            : null,
  ...
  GestureTapCallback _barrierOnTap() {
    return () {
      print("onTap barrier");
